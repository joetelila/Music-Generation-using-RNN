...
def messageHandler(update: Update, context: CallbackContext):
    ...
    #If user type sad emotion, Yoannis is activated somehow and generate a new sad song
    if "Sad" in user_input:
        context.bot.send_message(chat_id=update.effective_chat.id, text="Okay then, a sad song will be played")

    #If user type happy emotion, Yoannis is activated somehow and generate a new happy song
    if "Happy" in user_input:
        context.bot.send_message(chat_id=update.effective_chat.id, text="Okay then, a happy song will be played")
